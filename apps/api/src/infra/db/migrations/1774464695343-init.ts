...
export class Init1774464695343 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `CREATE TABLE "video_worker"."event" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "step" text NOT NULL, "status" text NOT NULL, "videoId" uuid NOT NULL, "cuCreatedat" TIMESTAMP NOT NULL DEFAULT now(), "cuUpdatedat" TIMESTAMP, CONSTRAINT "PK_30c2f3bbaf6d34a55f8ae6e4614" PRIMARY KEY ("id"))`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `CREATE TABLE "videos"."stability" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "startFrame" integer NOT NULL, "endFrame" integer NOT NULL, "startTime" double precision NOT NULL, "endTime" double precision NOT NULL, "predictedClass" integer NOT NULL, "confidence" double precision NOT NULL, "videoId" uuid NOT NULL, "cuCreatedat" TIMESTAMP NOT NULL DEFAULT now(), "cuUpdatedat" TIMESTAMP, CONSTRAINT "PK_2cb80d7901464cfbef0339e2603" PRIMARY KEY ("id"))`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `ALTER TABLE "units"."unit" ADD CONSTRAINT "FK_8585165b93f94f7df2f11edb8d6" FOREIGN KEY ("orgId") REFERENCES "orgs"."org"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `ALTER TABLE "videos"."stability" ADD CONSTRAINT "FK_044568f4d3a34bca17f5c708d18" FOREIGN KEY ("videoId") REFERENCES "videos"."video"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `ALTER TABLE "videos"."task_point_edit" ADD CONSTRAINT "FK_89e6be2d4154692ed3eb622d8fb" FOREIGN KEY ("userId") REFERENCES "users"."user"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `ALTER TABLE "videos"."task_point_edit" DROP CONSTRAINT "FK_89e6be2d4154692ed3eb622d8fb"`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `ALTER TABLE "videos"."stability" DROP CONSTRAINT "FK_044568f4d3a34bca17f5c708d18"`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `ALTER TABLE "units"."unit" DROP CONSTRAINT "FK_8585165b93f94f7df2f11edb8d6"`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(`DROP TABLE "videos"."stability"`);
