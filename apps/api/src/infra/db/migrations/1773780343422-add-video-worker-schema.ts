...
export class AddVideoWorkerSchema1773780343422 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `ALTER TABLE "videos"."keypoint" DROP COLUMN "data"`,
    );
    await queryRunner.query(
      `ALTER TABLE "videos"."keypoint" DROP COLUMN "assignmentId"`,
    );
    await queryRunner.query(`ALTER TABLE "units"."patient" ADD "unitId" uuid`);
    await queryRunner.query(
      `ALTER TABLE "units"."patient" ADD CONSTRAINT "UQ_26a9398fcdf4caf7bc9cfa7331f" UNIQUE ("unitId")`,
    );
    await queryRunner.query(
      `ALTER TABLE "videos"."patient_session" ADD "patientId" uuid`,
    );
    await queryRunner.query(
      `ALTER TABLE "videos"."patient_session" ADD CONSTRAINT "UQ_65356c73d71558fdb89bbfedd53" UNIQUE ("patientId")`,
    );
    await queryRunner.query(
      `ALTER TABLE "videos"."patient_session" ADD "unitId" uuid`,
    );
    await queryRunner.query(
      `ALTER TABLE "videos"."patient_session" ADD CONSTRAINT "UQ_733317a993491ab0fc01d067720" UNIQUE ("unitId")`,
    );
    await queryRunner.query(
      `ALTER TABLE "units"."file" ADD "uploadedById" uuid`,
    );
    await queryRunner.query(
      `ALTER TABLE "units"."file" ADD CONSTRAINT "UQ_6d2ab44c0a95eef23d952db9a79" UNIQUE ("uploadedById")`,
    );
    await queryRunner.query(`ALTER TABLE "units"."file" ADD "unitId" uuid`);
    await queryRunner.query(
      `ALTER TABLE "units"."file" ADD CONSTRAINT "UQ_2f793e90d64306181eaf03ad4b3" UNIQUE ("unitId")`,
    );
    await queryRunner.query(`ALTER TABLE "videos"."video" ADD "fileId" uuid`);
    await queryRunner.query(
      `ALTER TABLE "videos"."video" ADD CONSTRAINT "UQ_8736fb3e18f9cb3a9baacb252de" UNIQUE ("fileId")`,
    );
    await queryRunner.query(
      `ALTER TABLE "units"."assignment" ADD "sessionId" uuid`,
    );
    await queryRunner.query(
      `ALTER TABLE "units"."assignment" ADD CONSTRAINT "UQ_54d5f4839413371d1316ef58ec7" UNIQUE ("sessionId")`,
    );
    await queryRunner.query(
      `ALTER TABLE "units"."assignment" ADD "assignedToId" uuid`,
    );
    await queryRunner.query(
      `ALTER TABLE "units"."assignment" ADD CONSTRAINT "UQ_321b7c9b8b021bbb72c0dd66016" UNIQUE ("assignedToId")`,
    );
    await queryRunner.query(
      `ALTER TABLE "units"."assignment" ADD "assignedById" uuid`,
    );
    await queryRunner.query(
      `ALTER TABLE "units"."assignment" ADD CONSTRAINT "UQ_89872b43ab55aa4e9058fadb9de" UNIQUE ("assignedById")`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `ALTER TABLE "units"."unit_invite" ADD "unitId" uuid`,
    );
    await queryRunner.query(
      `ALTER TABLE "units"."unit_invite" ADD CONSTRAINT "UQ_a55a0b7a4b51ad002f4fdbee6cf" UNIQUE ("unitId")`,
    );
    await queryRunner.query(
      `ALTER TABLE "units"."unit_invite" ADD "invitedById" uuid`,
    );
    await queryRunner.query(
      `ALTER TABLE "units"."unit_invite" ADD CONSTRAINT "UQ_0cde52749dda28cc3f1b1aa3a05" UNIQUE ("invitedById")`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `ALTER TABLE "units"."file" ADD CONSTRAINT "FK_6d2ab44c0a95eef23d952db9a79" FOREIGN KEY ("uploadedById") REFERENCES "users"."user"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
      `ALTER TABLE "units"."file" ADD CONSTRAINT "FK_2f793e90d64306181eaf03ad4b3" FOREIGN KEY ("unitId") REFERENCES "units"."unit"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
      `ALTER TABLE "videos"."video" ADD CONSTRAINT "FK_8736fb3e18f9cb3a9baacb252de" FOREIGN KEY ("fileId") REFERENCES "units"."file"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `ALTER TABLE "units"."assignment" ADD CONSTRAINT "FK_321b7c9b8b021bbb72c0dd66016" FOREIGN KEY ("assignedToId") REFERENCES "users"."user"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
      `ALTER TABLE "units"."assignment" ADD CONSTRAINT "FK_89872b43ab55aa4e9058fadb9de" FOREIGN KEY ("assignedById") REFERENCES "users"."user"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `ALTER TABLE "units"."unit_invite" ADD CONSTRAINT "FK_a55a0b7a4b51ad002f4fdbee6cf" FOREIGN KEY ("unitId") REFERENCES "units"."unit"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
      `ALTER TABLE "units"."unit_invite" ADD CONSTRAINT "FK_0cde52749dda28cc3f1b1aa3a05" FOREIGN KEY ("invitedById") REFERENCES "users"."user"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `ALTER TABLE "units"."unit_invite" DROP CONSTRAINT "FK_0cde52749dda28cc3f1b1aa3a05"`,
    );
    await queryRunner.query(
      `ALTER TABLE "units"."unit_invite" DROP CONSTRAINT "FK_a55a0b7a4b51ad002f4fdbee6cf"`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `ALTER TABLE "units"."assignment" DROP CONSTRAINT "FK_89872b43ab55aa4e9058fadb9de"`,
    );
    await queryRunner.query(
      `ALTER TABLE "units"."assignment" DROP CONSTRAINT "FK_321b7c9b8b021bbb72c0dd66016"`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `ALTER TABLE "videos"."video" DROP CONSTRAINT "FK_8736fb3e18f9cb3a9baacb252de"`,
    );
    await queryRunner.query(
      `ALTER TABLE "units"."file" DROP CONSTRAINT "FK_2f793e90d64306181eaf03ad4b3"`,
    );
    await queryRunner.query(
      `ALTER TABLE "units"."file" DROP CONSTRAINT "FK_6d2ab44c0a95eef23d952db9a79"`,
    );
    await queryRunner.query(
      `ALTER TABLE "videos"."patient_session" DROP CONSTRAINT "FK_733317a993491ab0fc01d067720"`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `ALTER TABLE "units"."unit_invite" DROP CONSTRAINT "UQ_0cde52749dda28cc3f1b1aa3a05"`,
    );
    await queryRunner.query(
      `ALTER TABLE "units"."unit_invite" DROP COLUMN "invitedById"`,
    );
    await queryRunner.query(
      `ALTER TABLE "units"."unit_invite" DROP CONSTRAINT "UQ_a55a0b7a4b51ad002f4fdbee6cf"`,
    );
    await queryRunner.query(
      `ALTER TABLE "units"."unit_invite" DROP COLUMN "unitId"`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `ALTER TABLE "units"."assignment" DROP CONSTRAINT "UQ_89872b43ab55aa4e9058fadb9de"`,
    );
    await queryRunner.query(
      `ALTER TABLE "units"."assignment" DROP COLUMN "assignedById"`,
    );
    await queryRunner.query(
      `ALTER TABLE "units"."assignment" DROP CONSTRAINT "UQ_321b7c9b8b021bbb72c0dd66016"`,
    );
    await queryRunner.query(
      `ALTER TABLE "units"."assignment" DROP COLUMN "assignedToId"`,
    );
    await queryRunner.query(
      `ALTER TABLE "units"."assignment" DROP CONSTRAINT "UQ_54d5f4839413371d1316ef58ec7"`,
    );
    await queryRunner.query(
      `ALTER TABLE "units"."assignment" DROP COLUMN "sessionId"`,
    );
    await queryRunner.query(
      `ALTER TABLE "videos"."video" DROP CONSTRAINT "UQ_8736fb3e18f9cb3a9baacb252de"`,
    );
    await queryRunner.query(
      `ALTER TABLE "videos"."video" DROP COLUMN "fileId"`,
    );
    await queryRunner.query(
      `ALTER TABLE "units"."file" DROP CONSTRAINT "UQ_2f793e90d64306181eaf03ad4b3"`,
    );
    await queryRunner.query(`ALTER TABLE "units"."file" DROP COLUMN "unitId"`);
    await queryRunner.query(
      `ALTER TABLE "units"."file" DROP CONSTRAINT "UQ_6d2ab44c0a95eef23d952db9a79"`,
    );
    await queryRunner.query(
      `ALTER TABLE "units"."file" DROP COLUMN "uploadedById"`,
    );
    await queryRunner.query(
      `ALTER TABLE "videos"."patient_session" DROP CONSTRAINT "UQ_733317a993491ab0fc01d067720"`,
    );
    await queryRunner.query(
      `ALTER TABLE "videos"."patient_session" DROP COLUMN "unitId"`,
    );
    await queryRunner.query(
      `ALTER TABLE "videos"."patient_session" DROP CONSTRAINT "UQ_65356c73d71558fdb89bbfedd53"`,
    );
    await queryRunner.query(
      `ALTER TABLE "videos"."patient_session" DROP COLUMN "patientId"`,
    );
    await queryRunner.query(
      `ALTER TABLE "units"."patient" DROP CONSTRAINT "UQ_26a9398fcdf4caf7bc9cfa7331f"`,
    );
    await queryRunner.query(
      `ALTER TABLE "units"."patient" DROP COLUMN "unitId"`,
    );
    await queryRunner.query(
