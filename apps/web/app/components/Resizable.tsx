...
function ResizablePanel({
  ...
  return (
    <ResizablePrimitive.Panel data-slot="resizable-panel" {...props}>
      <Card className={cn("h-full overflow-hidden p-0", className)}>{children}</Card>
  ...
  return (
    <ResizablePrimitive.Separator
      ...
      className={cn(
        ...
        focus-visible:outline-hidden aria-[orientation=horizontal]:h-px aria-[orientation=horizontal]:w-full 
