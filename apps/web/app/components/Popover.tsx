  ...
  return (
    <PopoverPrimitive.Portal>
      <PopoverPrimitive.Content
        ...
        className={cn(
          "bg-popover data-[state=open]:animate-in data-[state=closed]:animate-out data-[state=closed]:fade-out-0",
          ...
          "origin-(--radix-popover-content-transform-origin) bg-background rounded-md border-1.5 border-accent shadow-sm p-3 z-50",
          className
        )}
        collisionPadding={18}
        {...props}
